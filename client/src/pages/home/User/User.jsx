...
function User() {
  ...
  //       headerRef.current ? headerRef.current.offsetHeight : 70;
  ...
  //               navActive
  //                 ? "flex flex-col absolute top-16 left-0 right-0 bg-white shadow-md py-4 px-5"
  //                 : "hidden"
  //             }`}
  //           >
  //             <li>
  ...
  //                 Smart QR-Based Road Transparency System
  //               </h1>
  ...
  //         {/* Services Section */}
          ...
          //     <p>
          //       Our platform revolutionizes infrastructure transparency by
          //       leveraging QR code technology. Each road project in our system has
          //       unique QR codes installed at both entry and exit points. When
          //       citizens scan these codes, they gain immediate access to:
          //     </p>
          //     <ul>
          //       <li>Complete contractor information and company details</li>
          //       <li>Detailed project budget and expenditure breakdown</li>
          //       <li>
          //         Official start and completion dates with progress tracking
          //       </li>
          ...
          //     </ul>
          //     <p>
          //       This system creates unprecedented transparency in public works
          //       projects, allowing citizens to verify project details and hold
          //       officials accountable. The platform also enables users to report
          //       issues or discrepancies directly through the interface.
          //     </p>
          //   </div>
          // </section>
  ...
  //         {/* Contact Section */}
          ...
          //           Have questions about our platform or want to implement it in
          //           your city? Reach out to us.
          //         </p>
  ...
  //         <p>
  //           &copy; {new Date().getFullYear()} Know Your Road. All rights reserved.
  //         </p>
  //       </footer>
  //     </div>
  //   );
  // }
  return (
   <nav className="w-full fixed top-0 left-0 bg-white text-black z-50 h-[90px]">
      <div className="max-w-7xl mx-auto px-5 py-3 flex items-center justify-between">
        <img src={LogoBgRemove} alt="Logo" className="w-[80px] h-auto" />
...
>>>>>>> de409181438035d53078758239a127f0873fded8
  );
}
export default User;
